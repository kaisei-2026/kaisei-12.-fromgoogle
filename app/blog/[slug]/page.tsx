...
export default async function PostPage({ params }: { params: { slug: string } }) {
  ...
  return (
    // 🌟 ページ全体のダークモード対応
    <div className="min-h-screen pt-32 pb-24 px-6 max-w-3xl mx-auto bg-white dark:bg-[#0a0a0a] font-sans transition-colors duration-300">
      ...
      <article>
        ...
        {/* 🌟 記事本文：prose-invert を追加してダークモード時に文字を白くする */}
      ...
      <footer className="mt-32 pt-12 border-t border-zinc-100 dark:border-zinc-800">
         <p className="text-center text-zinc-400 dark:text-zinc-600 text-xs tracking-widest uppercase font-bold">
            © 2026 KAISEI HUB.
         </p>
      </footer>
    </div>
