    ...
    <div className="bg-[#ffffff] dark:bg-[#0a0a0a] text-zinc-900 dark:text-zinc-100 font-serif selection:bg-zinc-900 dark:selection:bg-white selection:text-white dark:selection:text-zinc-900 pt-16 transition-colors duration-300">
      <section className="relative min-h-[70vh] md:min-h-[85vh] flex flex-col justify-end px-6 md:px-20 pb-12 md:pb-20 overflow-hidden bg-zinc-900">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.5 }} className="relative z-10 text-white">
          <h2 className="text-xl md:text-3xl font-bold mb-2 md:mb-4 tracking-tighter font-sans opacity-90 drop-shadow-md text-zinc-100 uppercase">{t.heroSub}</h2>
          <h1 className="text-[22vw] md:text-[16rem] font-bold tracking-tighter leading-[0.8] drop-shadow-2xl">KAISEI</h1>
        </motion.div>
      </section>
      ...
      <section className="py-20 md:py-40 px-6 md:px-20 max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-20 font-sans">
        <div className="lg:col-span-5">
          <h3 className="text-5xl md:text-7xl font-bold tracking-tighter mb-4 text-zinc-900 dark:text-white leading-none">{t.insightsTitle}</h3>
          <p className="text-zinc-400 text-xs mb-8 md:mb-12 font-sans tracking-widest uppercase">Expert Insights</p>
          <Link href="/blog/coding-agent" className="group block bg-[#0a0a0a] dark:bg-zinc-900 text-white p-8 md:p-12 rounded-[2.5rem] md:rounded-[3.5rem] hover:shadow-2xl transition-all">
            <time className="text-zinc-500 font-mono text-xs mb-4 block">2026.05.15</time>
            <h4 className="text-2xl md:text-4xl font-bold leading-tight mb-8 group-hover:text-emerald-400 transition-colors whitespace-pre-line">{t.articleTitle}</h4>
            <div className="flex justify-between items-center"><span className="text-[10px] font-bold tracking-[0.2em] opacity-60 uppercase font-sans">Read Article</span><ArrowUpRight size={20} /></div>
          </Link>
        </div>
        <div className="lg:col-span-7 flex flex-col justify-center">
          <h3 className="text-2xl font-bold mb-6 border-b border-zinc-100 dark:border-zinc-800 pb-4 text-zinc-900 dark:text-white">News</h3>
      ...
      <footer className="py-12 md:py-20 px-8 text-center bg-zinc-50 dark:bg-[#111] border-t border-zinc-100 dark:border-zinc-800 transition-colors duration-300 font-sans">
