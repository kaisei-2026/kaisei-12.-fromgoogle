...
export default function Home() {
  ...
  return (
    <div className="bg-white dark:bg-[#0a0a0a] text-zinc-900 dark:text-zinc-100 font-serif selection:bg-zinc-900 dark:selection:bg-white selection:text-white dark:selection:text-zinc-900 pt-16 transition-colors duration-300">
      ...
      <section className="relative min-h-[70vh] md:min-h-[85vh] flex flex-col justify-end px-6 md:px-20 pb-12 md:pb-20 overflow-hidden bg-zinc-900">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="relative z-10 text-white">
          <h2 className="text-xl md:text-3xl font-bold mb-2 md:mb-4 tracking-tighter font-sans opacity-90 text-zinc-100 uppercase">
      ...
      <section className="py-20 md:py-40 px-6 md:px-20 max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-20">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center">
          <h3 className="text-2xl font-bold mb-6 font-sans border-b border-zinc-100 dark:border-zinc-800 pb-4">News</h3>
