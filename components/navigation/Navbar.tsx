...
export default function Navbar() {
  ...
  return (
    // 🌟 z-[9999] を指定して、何があっても一番上に表示されるようにする
    <nav className="fixed top-0 w-full z-[9999] bg-white/90 backdrop-blur-md border-b border-zinc-200 px-6 py-4">
      ...
      {isOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-white border-b border-zinc-200 p-6 flex flex-col gap-6 font-bold text-zinc-800 shadow-xl">
